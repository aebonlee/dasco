import{j as e,L as s}from"./index-_diQEObP.js";import{S as l}from"./SEOHead-CIHTwD_5.js";const i=()=>e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"프롬프트 학습",description:"생성형AI 프롬프트 작성법과 핵심 기법을 학습합니다"}),e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h2",{children:"프롬프트 학습"}),e.jsx("p",{children:"ChatGPT 등 생성형AI를 효과적으로 활용하기 위한 프롬프트 작성 기법"})]})}),e.jsx("section",{className:"section",children:e.jsxs("div",{className:"lecture-page",children:[e.jsxs("div",{className:"lecture-section",children:[e.jsx("h3",{children:"1. 프롬프트(Prompt)란?"}),e.jsxs("div",{className:"lecture-content",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"프롬프트"}),"란 AI에게 보내는 지시문, 질문, 요청을 말합니다. 프롬프트의 품질이 AI 응답의 품질을 결정합니다."]}),e.jsxs("div",{className:"tip-box",children:[e.jsx("strong",{children:"핵심 원칙"}),": 프롬프트가 구체적이고 명확할수록, AI의 답변도 정확하고 유용해집니다."]}),e.jsx("h4",{children:"좋은 프롬프트 vs 나쁜 프롬프트"}),e.jsxs("div",{className:"example-box",children:[e.jsx("strong",{children:"나쁜 예시"}),': "보고서 써줘"',e.jsx("br",{}),"→ AI가 어떤 보고서를 쓸지 모르기 때문에 모호한 결과가 나옵니다."]}),e.jsx("div",{className:"prompt-example",children:`[좋은 예시]
