export const translations: Record<string, Record<string, unknown>> = {
  ko: {
    ...
    site: {
      ...
      home: {
        ...
        subtitle: '다스코(주) 직원을 위한 생성형 인공지능 업무 활용 교육',
        welcome: '생성형AI 교육 플랫폼에 오신 것을 환영합니다.',
        description: 'ChatGPT, Gemini 등 생성형AI를 업무에 효과적으로 활용하는 방법을 학습합니다.'
      }
    }
  },
  ...
  en: {
    ...
    site: {
      ...
      home: {
        title: 'DASCO AI Academy',
        subtitle: 'Generative AI training for DASCO employees',
        welcome: 'Welcome to the Generative AI Training Platform.',
        description: 'Learn how to effectively leverage ChatGPT, Gemini, and other generative AI tools for your work.'
      }
    }
  }
};
